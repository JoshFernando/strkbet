...
export declare const DOCKER_REPOSITORY = "shardlabs/cairo-cli";
export declare const DEFAULT_DOCKER_IMAGE_TAG = "0.7.1";
export declare const ACCOUNT_CONTRACT_ARTIFACTS_ROOT_PATH = "account-contract-artifacts";
export declare const ACCOUNT_ARTIFACTS_VERSION = "0.1.0";
export declare const GITHUB_ACCOUNT_ARTIFACTS_URL: string;
export declare const ALPHA_TESTNET = "alpha-goerli";
export declare const ALPHA_TESTNET_INTERNALLY = "alpha";
export declare const ALPHA_MAINNET = "alpha-mainnet";
export declare const ALPHA_MAINNET_INTERNALLY = "alphaMainnet";
export declare const DEFAULT_STARKNET_NETWORK = "alpha";
...
export declare const PENDING_BLOCK_NUMBER = "pending";
