...
class StarknetWrapper {
    ...
    getPythonDeployAccountScript(options) {
...
class DockerWrapper extends StarknetWrapper {
    ...
    deployAccount(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const docker = yield this.getDocker();
            const executed = yield docker.runContainer(this.image, ["python", "-c", deployAccountScript], dockerOptions);
            return executed;
        });
    }
}
...
class VenvWrapper extends StarknetWrapper {
    ...
    deployAccount(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const deployAccountScript = this.getPythonDeployAccountScript(options);
            const executed = yield this.execute("python", ["-c", deployAccountScript]);
            return executed;
        });
    }
}
